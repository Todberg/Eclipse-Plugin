...
public class AperiodicEventHandlerTemplate
{
  ...
  protected final String TEXT_3 = " extends AperiodicEventHandler {" + NL + "" + NL + "\tpublic ";
  protected final String TEXT_4 = "(PriorityParameters priority, ";
  protected final String TEXT_5 = " release, StorageParameters storage, long scopeSize) {" + NL + "\t\tsuper(priority, release, storage, scopeSize);" + NL + "\t\t// TODO Auto-generated constructor stub" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\t@SCJAllowed(Level.SUPPORT)" + NL + "\tpublic void handleAsyncEvent() {" + NL + "\t\t// TODO Auto-generated method stub\t" + NL + "\t}" + NL + "}";
