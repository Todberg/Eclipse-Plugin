...
import cassiopeia.plugin.listeners.SelectionListener;
...
public class AnalysisView extends ViewPart {
	...
	@Override
	public void dispose() {
		getSite().getWorkbenchWindow().getSelectionService().removePostSelectionListener(SelectionListener.getListener());
		super.dispose();
	}
